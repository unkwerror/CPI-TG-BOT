-- Recovery for deployments where 0003 was older than an already recorded
-- migration and Drizzle therefore skipped it. Keep this migration idempotent:
-- a fresh database legitimately executes both 0003 and this recovery migration.
