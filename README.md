...
Обновление от 7 сентября 2026: [нативный магазин, Leader-ID и заявки коворкинга](docs/native-studio-20260907.md).
...
После готовности всех файлов worker отправляет в CRM профиль отправителя, мероприятие,
содержимое отправки и метаданные файлов. CRM возвращает `personId`, который сохраняется
